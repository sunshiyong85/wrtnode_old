...
Source: asterisk-1.8.30.0.tar.gz
Type: ipkg
Feed: telephony
...
Submenu: Telephony
Version: 1.8.30.0-2
Depends: +libc +USE_EGLIBC:librt +USE_EGLIBC:libpthread asterisk18 @(TARGET_lantiq_falcon||TARGET_lantiq_xway||TARGET_lantiq_xrx200) +TARGET_lantiq_xway:kmod-ltq-tapi +TARGET_lantiq_xway:kmod-ltq-vmmc +TARGET_lantiq_xrx200:kmod-ltq-tapi +TARGET_lantiq_xrx200:kmod-ltq-vmmc +TARGET_lantiq_falcon:kmod-ltq-tapi +TARGET_lantiq_falcon:kmod-ltq-vmmc
Menu-Depends: 
Provides: 
Section: net
Category: Network
...
Submenu: Telephony
Version: 1.8.30.0-2
Depends: +libc +USE_EGLIBC:librt +USE_EGLIBC:libpthread asterisk18 +PACKAGE_asterisk18-chan-gtalk:libiksemel
Menu-Depends: 
Provides: 
Section: net
Category: Network
...
Description:    Asterisk is a complete PBX in software. It provides all of the features
 ...
 protocols, and can interoperate with almost all standards-based telephony
 equipment using relatively inexpensive hardware.
This package provides support An implementation of chan_gtalk and res_jabber for GTalk support in Asterisk.
http://www.asterisk.org/
Jiri Slachta <slachta@cesnet.cz>
@@
